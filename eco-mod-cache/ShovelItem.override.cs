...
namespace Eco.Mods.TechTree
{
    ...
    public abstract partial class ShovelItem : ToolItem, IInteractor
    {
        ...
        public override int                        MaxTake                           => 1000; //change this to increase/decrease amount of all shovels
        ...
        [Interaction(InteractionTrigger.LeftClick, tags: BlockTags.Diggable, canHoldToTrigger: TriBool.True, animationDriven: true)] // change animationDriven to true to bring back regular shovel
        public bool Dig(Player player, InteractionTriggerInfo triggerInfo, InteractionTarget target)
        {
            ...
            if (this.MaxTake > 0 && carry.Quantity >= 20)
            {
        ...
        [Interaction(InteractionTrigger.InteractKey, tags: BlockTags.Diggable, canHoldToTrigger: TriBool.True, animationDriven: false)] // change animationDriven to true to bring back regular shovel
        public bool PressEbuttonToDig(Player player, InteractionTriggerInfo triggerInfo, InteractionTarget target)
        {
            // Fallback if not enough room in carrying stack
            var carry = player.User.Carrying;
            if (this.MaxTake > 0 && carry.Quantity >= 20)
